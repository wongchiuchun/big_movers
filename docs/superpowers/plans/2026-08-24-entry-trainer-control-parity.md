...
- [x] **Step 1: Extend the optional flat-policy contract**
...
- [x] **Step 2: Capture complete controller history**
...
- [x] **Step 3: Restore complete controller and caller state**
...
- [x] **Step 4: Permit flat autoplay when policy allows it**
...
- [x] **Step 5: Capture each bar before policy callbacks mutate it**
...
- [x] **Step 1: Capture Entry Trainer-owned history**
...
- [x] **Step 2: Restore Entry Trainer-owned history**
...
- [x] **Step 3: Keep limit fills atomic**
...
- [x] **Step 4: Enable consistent controls**
...
- [x] **Step 5: Preserve the expand control**
...
- [x] **Step 1: Inspect targeted diffs**
...
- [x] **Step 2: Run static checks only**

...
- [x] **Step 1: Create the UMD-style asset helper**
...
- [x] **Step 2: Load the helper before `Big_movers.html` inline modules**
...
- [x] **Step 3: Commit the helper boundary**
...
- [x] **Step 1: Add accessible tab controls and separate grids**
...
- [x] **Step 2: Add compact tab and hidden-panel styles**
...
- [x] **Step 3: Add idempotent tab wiring in the controller**
...
- [x] **Step 1: Reject reserved aliases in setup validation**
...
- [x] **Step 2: Reject aliases in runtime add/replace**
...
- [x] **Step 3: Stamp stock identity fields**
...
- [x] **Step 4: Commit stock/index separation rules**
...
- [x] **Step 1: Add state and shared card-entry construction**
...
- [x] **Step 2: Render both index card shells immediately**
...
- [x] **Step 3: Hydrate without changing the simulation timeline**
...
- [x] **Step 4: Keep benchmark loading independent**
...
- [x] **Step 5: Destroy index cards on replay/exit**
...
- [x] **Step 6: Commit fixed index-card lifecycle**
...
- [x] **Step 1: Add controller-local collection helpers**
...
- [x] **Step 2: Advance and force-close all live entries**
...
- [x] **Step 3: Include indices in valuation and deployment**
...
- [x] **Step 4: Update chart-side consumers**
...
- [x] **Step 5: Include asset identity in Stats records**
...
- [x] **Step 6: Commit the combined execution boundary**
...
- [x] **Step 1: Export all trade entries**
...
- [x] **Step 2: Persist index metadata in Review snapshots**
...
- [x] **Step 3: Bypass basket-role resolution for indices**
...
- [x] **Step 4: Keep rerun stock-only**
...
- [x] **Step 5: Make Review charts proxy- and identity-aware**
...
- [x] **Step 6: Commit reporting integration**
...
- [x] **Step 1: Snapshot the existing shared metrics**
...
- [x] **Step 2: Copy Stats metrics into reconstructed session Reviews**
...
- [x] **Step 3: Add three Overview tiles**
...
- [x] **Step 1: Parse the helper and every inline script**
...
- [x] **Step 3: Commit plan checkbox updates if needed**
...
- [x] **Step 4: Fast-forward merge the feature branch into local main**
